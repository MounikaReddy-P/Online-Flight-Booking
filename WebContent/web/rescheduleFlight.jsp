						...
						<div class="well">
							<div class="tab-content">
								<div class="tab-pane fade in active" id="tab1">
									<form action="findRescheduledFlights.jsp" method="post">

										<div class="form-group">
											<div class="form-group col-lg-6">
												<input type="text" name="from_location" class="form-control" id=""
													value="" placeholder="Kansas" readonly >
											</div>
											<div class="form-group col-lg-6">
												<input type="text" name="to_location" class="form-control" id=""
													value="" placeholder="Hyderabad" readonly>
											</div>
										...
										<div class="form-group col-lg-6">
										<select id="travelClass" class="form-control" name="travel_class" readonly>
										...
										<div class="form-group col-lg-6">
											<div class="input-group">
												<span class="input-group-addon"><span
													...
													class="form-control" placeholder="1" name="passengers" readonly />
											</div>
										</div>
