...
<SCRIPT  type="text/javascript">
	...
	function alertIt() {
	    ...
	    if( x == "You pressed OK!"){
	    	var answer = confirm ("Your booking has been cancelled successfully")
	    	if (answer)
							...
							<div>
								...
								<ul class="nav">
											<li class="dropdown"><a href="#" class="dropdown-toggle"
												...
												<ul class="dropdown-menu">
													<li><a href="rescheduleFlight.jsp">Reschedule Booking</a></li>
													<li class="divider"></li>
													<li>
													<a href="#" onClick="alertIt();">Cancel Booking</a></li>	
							...
							<table class="table table-striped ">
								...
								<tbody>
									<tr class="table-active">
										...
										<td class="bg-success">21 Dec 2016</td>
										<td class="bg-success">Flight No:6617</td>
										<td class="bg-success">15:10 Depart Kansas City(MCI)</td>
										<td class="bg-success"></td>
										<td class="bg-success">USD 650</td>
										<td class="bg-success"></td>
										<td class="bg-success">2E</td>
									</tr>
									<tr>

										<td class="bg-success"></td>
										<td class="bg-success"></td>
										<td class="bg-success">23:10 Arrive Dubai(DXB)</td>
										<td class="bg-success"></td>
									...
									<tr class="table-active">
										...
										<td class="bg-success">01:00 Depart Dubai(DXB)</td>
										<td class="bg-success"></td>
										<td class="bg-success"></td>
										<td class="bg-success"></td>
										<td class="bg-success"></td>
									...
									<tr>
										...
										<td class="bg-success"></td>
										<td class="bg-success"></td>
										<td class="bg-success">02:45 Arrive Hyderabad(HYD)(+2
											Day)</td>
										<td class="bg-success"></td>
										<td class="bg-success"></td>
										<td class="bg-success"></td>
								...
								<!-- 
													...
													<div class="col-xs-4">
														<button id="confirmSelection"
															class="btn btn-primary ">Confirm Selection</button>
													</div>
													</form> -->
							</div>
