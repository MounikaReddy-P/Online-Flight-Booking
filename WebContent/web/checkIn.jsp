							...
							<table class="table table-striped ">
								...
								<tbody>
									...
									<tr>
										...
										<td class="bg-success"> <h4><strong>A 22</strong></h4></td>
										<td class="bg-success"></td>
										<td class="bg-success">23:10 Arrive Dubai(DXB)</td>
										<td class="bg-success"><img src="${contextPath}images/code.png" width="100" height="100"></img></td>
									...
									<tr>
										...
										<td class="bg-success">  <h4><strong>B 31</strong></h4></td>
										<td class="bg-success"></td>
