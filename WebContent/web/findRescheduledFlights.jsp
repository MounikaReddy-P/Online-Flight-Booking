							...
							<table class="table table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td><c:out value="Kansas"/></td>
										<td><c:out value="Hyderabad"/></td>
								 		<td><c:out value="2016-12-27"/></td>
								 		<td><c:out value="-"/></td>
								 		<td><c:out value="Economy"/></td>
								 		<td><c:out value="1 Adult"/></td>
									</tr>
							
									
								</tbody>
							</table>
							<form action="${contextPath}web/payment1.jsp" method="post">
							<table class="table">
								<thead>
									<tr class="bg-warning">
										<th></th>
								...
								<tbody>
									...
									<tr class="table-active">
										...
										<td class="bg-success"><c:out value="15:10 27Dec"/></td>
										<td class="bg-success"><c:out value="02:45 29Dec"/></td>
								 		<td class="bg-success"><c:out value="MCI->HYD"/></td>
								 		<td class="bg-success"><c:out value="24hrs 45mins"/></td>
								 		<td class="bg-success"><c:out value="1"/></td>
								 		<td class="bg-success"><c:out value="Economy"/></td>
								 		<td class="bg-success">$<c:out value="900"/></td>
									...
									<tr class="table-active">
										...
										<td class="bg-success"><c:out value="17:10 27Dec"/></td>
										<td class="bg-success"><c:out value="04:45 29Dec"/></td>
								 		<td class="bg-success"><c:out value="MCI->HYD"/></td>
								 		<td class="bg-success"><c:out value="24hrs 45mins"/></td>
								 		<td class="bg-success"><c:out value="1"/></td>
								 		<td class="bg-success"><c:out value="Economy"/></td>
								 		<td class="bg-success">$<c:out value="750"/></td>
