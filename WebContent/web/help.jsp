...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDsbDwbjawwPNVDr2orAqhYBH6Dtbflybc&callback=initMap"
...
function initialize() {
  ...
  var mapOptions = {
      center: new google.maps.LatLng(30.5236117, -91.193589),
    zoom: 17,
						...
						<div class="form-group">
							<form>
							 <fieldset>
								...
								<address>
									<strong>JuzzGo, Inc.</strong><br> 1121 N College Dr<br> Maryville, MO 64468<br> <abbr
										title="Phone"> P:</abbr> (123) 456-7890
								</address>
								<address>
									<strong>Full Name</strong><br> <a href="mailto:#">juzzgo@mail.com</a>
								</address>
							</form>
						</div>
					</div>
